...
setup(
    ...
    install_requires=[
        ...
        "pymanopt == 0.2.5",
        "progress",
        "urdfpy @ git+https://git@github.com/utiasSTARS/urdfpy@master#egg=urdfpy",
        "trimesh <= 3.7.12",
        "numba",
        "liegroups @ git+https://git@github.com/utiasSTARS/liegroups@generative_ik#egg=liegroups",
        "pandas >= 0.24.2",
        "pytest",
    ],
    python_requires=">=3.7",
